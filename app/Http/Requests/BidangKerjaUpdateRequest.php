...
class BidangKerjaUpdateRequest extends FormRequest
{
    ...
    {
        $bidangKerjaId = $this->route('bidang_kerja')?->id;

        return [
            'kode'      => ['required', 'string', 'max:5', 'unique:bidang_kerja,kode,' . $bidangKerjaId],
