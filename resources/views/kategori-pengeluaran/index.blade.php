<x-app-layout>
    <x-slot:title>Kategori Pengeluaran</x-slot>
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-5">
        <p class="text-xs text-gray-500">
            Kelola master data kategori pengeluaran
        </p>
        <a href="{{ route('kategori-pengeluaran.create') }}"
    ...
    <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-4 mb-5">
        <form method="GET" action="{{ route('kategori-pengeluaran.index') }}" class="flex flex-col sm:flex-row items-stretch sm:items-end gap-3">
            <div class="flex-1">
            ...
            <div class="flex gap-2">
                ...
                @if ($search)
                    <a href="{{ route('kategori-pengeluaran.index') }}"
    ...
    <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm">
        ...
        <div class="p-4 sm:p-5 border-b border-gray-100">
            <div class="flex flex-col xs:flex-row xs:items-center xs:justify-between gap-2">
                <div>
                    <h2 class="font-semibold text-gray-900 text-sm">Daftar Kategori Pengeluaran</h2>
                        ...
                        <tr class="hover:bg-gray-50/70 transition group">
                            ...
                            <td class="px-4 py-3 align-middle text-center">
                                <div class="flex items-center justify-center gap-1.5">
                                    <a href="{{ route('kategori-pengeluaran.edit', $item->id) }}"
                            ...
                            <td colspan="3" class="px-4 py-12 text-center">
                                <div class="flex flex-col items-center justify-center gap-2">
                                    ...
                                    <p class="text-xs text-gray-500 max-w-[250px]">
                                        Silakan tambah kategori pengeluaran pertama Anda.
                                    </p>
                                </div>
                            </td>
                        </tr>
