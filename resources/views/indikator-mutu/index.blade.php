<x-app-layout>
    ...
    <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm mb-5">
        ...
        <div class="px-5 py-4 border-b border-gray-100 flex items-center gap-1.5">
            <span class="material-symbols-outlined text-gray-400 text-[18px]">pie_chart</span>
            <h2 class="font-semibold text-gray-900 text-sm">Ringkasan Capaian Per Bidang</h2>
        </div>
                        ...
                        <tr class="hover:bg-gray-50/50 transition-colors">
                            ...
                            <td class="px-5 py-3 align-top">
                                <a href="{{ route('indikator-mutu.index', ['bidang' => $bidang->id]) }}"
                                    ...
                                    <span class="material-symbols-outlined text-[14px] {{ $activeBidang === $bidang->id ? 'text-primary' : 'text-gray-400' }}">
                                        {{ $bidang->icon ?? 'domain' }}
                                    </span>
                                    {{ $bidang->nama }}
                                </a>
