<x-app-layout>
    <x-slot:title>Edit Kategori Pendapatan</x-slot>
    ...
    <div class="border-b border-gray-100 pb-5 mb-5">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h2 class="text-lg font-semibold text-gray-900">Edit Kategori Pendapatan</h2>
                <p class="text-sm text-gray-500 mt-0.5">
                    Ubah data kategori pendapatan
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden max-w-2xl">
        <form method="POST" action="{{ route('kategori-pendapatan.update', $kategoriPendapatan->id) }}" class="p-6">
            @csrf
            @method('PUT')
            ...
            <div class="mb-6">
                ...
                <x-text-input id="nama" name="nama" type="text" class="block w-full"
                    :value="old('nama', $kategoriPendapatan->nama)" required autofocus autocomplete="off" />
