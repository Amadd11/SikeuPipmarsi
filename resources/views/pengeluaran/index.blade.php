<x-app-layout>
    ...
    {{-- Secondary Card: Ringkasan Seluruh Bidang --}}
    <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm mb-5">

        <div class="px-5 py-4 border-b border-gray-100 bg-white flex items-center gap-1.5">
            ...
            <table class="w-full text-xs text-left">
                <thead
                    ...
                    <tr>
                        ...
                        <th class="px-5 py-2.5 w-32">Serapan</th>
                    </tr>
                </thead>

                <tbody class="divide-y divide-gray-100 text-gray-700">

                    @forelse ($ringkasanBidang as $bidang)
                        <tr class="hover:bg-gray-50/50 transition-colors">
                            ...
                            <td class="px-5 py-3 align-top">
                                <a href="{{ route('pengeluaran.index', ['tahun' => $activeTahun, 'bidang' => $bidang->id]) }}"
                                    ...
                                    <span
                                        class="material-symbols-outlined text-[14px] {{ $activeBidang === $bidang->id ? 'text-primary' : 'text-gray-400' }}">
                                        {{ $bidang->icon ?? 'domain' }}
                                    </span>
                                    {{ $bidang->nama }}
                                </a>
                            ...
                            <td
                                class="px-5 py-3 font-medium text-right align-top whitespace-nowrap {{ $bidang->total_realisasi > 0 ? 'text-green-600' : 'text-gray-500' }}">
                            ...
                            <td class="px-5 py-3 align-top">
                                <div class="flex items-center gap-2 mt-0.5">
                                    ...
                                    <span
                                        class="text-[10px] text-gray-500 font-medium w-6 text-right">{{ $bidang->persen }}%</span>
                                </div>
                            </td>
