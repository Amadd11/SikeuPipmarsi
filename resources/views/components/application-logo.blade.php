<div {{ $attributes->merge(['class' => 'flex items-center gap-3 sm:gap-4 select-none']) }}>
    <div class="w-14 h-14 shrink-0">
        <img src="{{ asset('images/logo-pipmarsi.png') }}" alt="Logo PIPMARSI" class="w-full h-full object-contain">
    </div>
